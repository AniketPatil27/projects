...
public class UpdateCourseInfo extends javax.swing.JFrame {
...
ResultSet rs;
    ...
    private void initComponents() {
        ...
        jButton3.setText("Display Previous Details");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(70, 70, 70)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtCourse, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public void option()
    {
        ...
        try {
            ...
            txtOption.removeAllItems();
            
            while(rs.next())
            {
                txtOption.addItem(rs.getString("coursename"));
            }
    ...
    public void input()
    {
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            con =  (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/collegemanagement","root","root");
            pst=(PreparedStatement) con.prepareStatement("select * from course where id=?");
            ...
            while(rs.next())
            {
               txtCourse.setText(rs.getString("coursename"));
                ...
                txtOption.setSelectedItem(rs.getString("optionn"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con =  (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/collegemanagement","root","root");
            pst = (PreparedStatement) con.prepareStatement("update course set coursename=?,duration=?,optionn=? where id=?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCourseInfo().setVisible(true);
            }
        });
    }
